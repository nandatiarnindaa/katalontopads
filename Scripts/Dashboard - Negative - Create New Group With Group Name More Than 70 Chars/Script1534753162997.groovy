...
WebUI.setText(findTestObject('Object Repository/Page_Daftar Iklan  Tokopedia/input_group-name__input'), 'grup' + RandomStringUtils.randomNumeric(80))

WebUI.click(findTestObject('Choose 1st Product'))

WebUI.click(findTestObject('login/Page_Masuk  Tokopedia/button_Simpan'))

WebUI.verifyElementText(findTestObject('error_group_name_length'), 'Maksimal karakter : 70 karakter')

//WebUI.executeJavaScript("alert('Yeaaah')", null)
