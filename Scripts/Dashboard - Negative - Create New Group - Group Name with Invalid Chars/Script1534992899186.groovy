...
WebUI.setText(findTestObject('Object Repository/Page_Daftar Iklan  Tokopedia/input_group-name__input'), '<>?:')

WebUI.click(findTestObject('Choose 1st Product'))

WebUI.click(findTestObject('login/Page_Masuk  Tokopedia/button_Simpan'))

WebUI.verifyElementText(findTestObject('error_group_name_invalid_char'), 'Nama grup tidak valid')
